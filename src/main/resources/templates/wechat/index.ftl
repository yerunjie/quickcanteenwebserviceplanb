...
<html>
	...
	<body>
		...
		<header >
			...
			<a class="rt_searchIcon" href="map.html"><img style="width:70%;" src="/image/mapIcon.png"></a>
		</header>
	        ...
	        <div class="swiper-slide">
	        	<div class="right-con con-active">
					<ul class="clearfix swiper-list">
						<li>
							<div class="menu-img"><img src="/image/index (1).png" width="55" height="55" /></div>
							<div class="menu-txt">
								<h4>宫保鸡丁</h4>
								<p class="list2">
									<b>￥25<em>(6折)</em></b>
						...
						<li>
							<div class="menu-img"><img src="/image/index (2).png" width="55" height="55" /></div>
							<div class="menu-txt">
								<h4>宫保鸡丁</h4>
								<p class="list2">
									<b>￥25<em>(6折)</em></b>
...
<nav>
	<a href="index.html" class="homeIcon addclasstruenav"><img src="/image/index1-1.png">点餐</a>
	<a href="my-order.html" class="categoryIcon"><img src="/image/index2.png">订单</a>
